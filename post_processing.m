function post_processing(dataset,datasetlabelsNMC,datasetlabelsknn,datasetlabelssvm,PatientID)
...
hImgAxes = imagine(dataset{12,1}.Image(:,:,:,5),'T2',dataset{PatientID,1}.labelsHisto,'Histo',datasetlabelsNMC,'nearest mean',NMCdilate,'NM+PP');
hImgAxes1 = imagine(dataset{12,1}.Image(:,:,:,5),'T2',dataset{PatientID,1}.labelsHisto,'Histo',datasetlabelsknn,'kNN',knn12dilate,'kNN+PP');
hImgAxes2 = imagine(dataset{12,1}.Image(:,:,:,5),'T2',dataset{PatientID,1}.labelsHisto,'Histo',datasetlabelssvm,'SVM',svmdilate,'SVM+PP');